...
<polymer-element name="core-header-panel" assetpath="polymer-tutorial-master/components/core-header-panel/">
<template>
...
<polymer-element name="core-toolbar" assetpath="polymer-tutorial-master/components/core-toolbar/">
<template>
...
<polymer-element name="core-selection" attributes="multi" hidden assetpath="polymer-tutorial-master/components/core-selection/">
  <script>
...
<polymer-element name="core-selector" attributes="selected multi valueattr selectedClass selectedProperty selectedAttribute selectedItem selectedModel selectedIndex notap target itemsSelector activateEvent" assetpath="polymer-tutorial-master/components/core-selector/">
...
<polymer-element name="paper-ripple" attributes="initialOpacity opacityDecayVelocity" assetpath="polymer-tutorial-master/components/paper-ripple/">
<template>
...
<polymer-element name="paper-tab" attributes="noink" assetpath="polymer-tutorial-master/components/paper-tabs/">
<template>
...
<polymer-element name="paper-tabs" extends="core-selector" attributes="noink nobar" assetpath="polymer-tutorial-master/components/paper-tabs/">
<template>
...
<polymer-element name="core-xhr" hidden assetpath="polymer-tutorial-master/components/core-ajax/">
...
<polymer-element name="core-ajax" attributes="url handleAs auto params response method headers body contentType withCredentials" assetpath="polymer-tutorial-master/components/core-ajax/">
<script>
...
<!--
  ...
  @default []
-->
<polymer-element name="post-service" attributes="posts" assetpath="polymer-tutorial-master/post-service/">
  <template>
    <style>
    :host {
      display: none;
...
<polymer-element name="core-meta" attributes="list label type" hidden assetpath="polymer-tutorial-master/components/core-meta/">
<script>
...
<polymer-element name="core-iconset" extends="core-meta" attributes="src width icons iconSize" assetpath="polymer-tutorial-master/components/core-iconset/">
...
<polymer-element name="core-icon" attributes="src size icon" assetpath="polymer-tutorial-master/components/core-icon/">
<script>
(function() {
...
<polymer-element name="core-item" attributes="label icon src" horizontal="" center="" layout="" assetpath="polymer-tutorial-master/components/core-item/">
<template>
...
<style shim-shadowdom="">html /deep/ paper-item {
  display: block;
  position: relative;
...
<polymer-element name="paper-item" attributes="label iconSrc icon" center="" horizontal="" layout="" assetpath="polymer-tutorial-master/components/paper-item/">
...
<polymer-element name="resume-data" attributes="resume" assetpath="polymer-tutorial-master/finished/">
  <template>
    <style>
    :host {
      display: none;
  ...
  Polymer('resume-data', {
    created: function() {
      this.resume = {"basics":{"name":"Karn Wong","label":"Senior Data Engineer","picture":"","email":"contact@karnwong.me","phone":"","website":"https://www.karnwong.me","summary":null,"location":{"city":"Bangkok","countryCode":"Thailand"},"profiles":[{"network":"Github","username":"kahnwong","url":"https://github.com/kahnwong"}],"gravatar":"//www.gravatar.com/avatar/798939dc260af7fc0d8caae053eb743f?s=100&r=pg&d=mm"},"work":[{"company":"Baania","position":"Data Engineer","website":"https://www.baania.com","startDate":"2018-04-02","endDate":"2021-01-29","highlights":["Create and maintain data gathering infrastructure for daily ingestion and processing to be stored in data lake (S3)","Create and optimize machine learning models to achieve near-realtime performance","Create and maintain ETL pipelines via Dagster to reduce data update frequency from once a month to daily","Deploy and maintain ML via cloud services to reduce ML deployment time from a day to within minutes","Mentor junior data scientists","Infrastructure planning","Automate infrastructure and governance using Terraform"],"startDateYear":"2018","endDateYear":"2021"},{"company":"Baania","position":"Senior Data Engineer","website":"https://www.baania.com","startDate":"2021-01-29","endDate":null,"highlights":["Oversee implemention of a 5-year-plan for data team"],"startDateYear":"2021","endDateYear":"Present"}],"education":[{"institution":"Rangsit University","area":"Information and Communication Technology","studyType":"Bachelor","startDate":"2015-08-01","endDate":"2018-05-01","startDateYear":"2015","endDateYear":"2018"}],"publications":[{"name":"Using Classification Technique for Customer Relationship Management based on Thai Social Media Data","publisher":"ICCAE","releaseDate":"2019-01-01","website":"https://doi.org/10.1145/3313991.3314010"}],"skills":[{"name":"Data Science & Machine Learning","keywords":["Pandas","Sklearn","Matplotlib","Seaborn"]},{"name":"Big Data","keywords":["Hadoop","Hive","Spark","Dagster"]},{"name":"Cloud","keywords":["AWS","Digital Ocean"]},{"name":"Databases","keywords":["MariaDB / MySQL","SQLite","PostgreSQL / PostGIS","MongoDB"]},{"name":"DevOps","keywords":["Docker","Kubernetes","Terraform"]},{"name":"Programming","keywords":["Python","Bash"]},{"name":"Web Scraping","keywords":["Selenium","BeautifulSoup","Scrapy"]},{"name":"Other Skills","keywords":["Linguistics","NLP","GIS","Linux"]}],"languages":[{"language":"English","fluency":"Native speaker"},{"language":"Thai","fluency":"Native speaker"}],"interests":[{"name":"Music","keywords":["Symphonic Heavy Metal","Turkish Pop","Folk Metal"]}],"projects":[{"name":"Self-hosting","description":"Self-hosting services on my home server / VPS via docker-compose and reverse-proxy via apache.","highlights":["Hosted on a laptop from 2015 with 16GB RAM","Alternative / self-hosted version for popular subscription services: Netflix, Spotify, Pocket, LastPass, Audible, Confluence, Ghost, Trello, Feedly, Dropbox, NordVPN, etc.","Managed via docker-compose"],"keywords":["Docker","Reverse-proxy","DevOps"],"startDate":"2017-12-01","type":"service"},{"name":"gcal-agenda","description":"Generate a kindle dashboard view of today's calendar agenda and weather forecast using REST APIs for data and python for html generation.","highlights":["Lightweight with only python and webserver","Webpage refreshes every 30 minutes"],"keywords":["google-api","dashboard","calendar"],"startDate":"2020-10-11","endDate":"2020-11-11","url":"https://github.com/kahnwong/gcal-agenda","type":"service"}]};
    },
    postsLoaded: function() {
      // Make a copy of the loaded data
      //this.posts = this.$.ajax.response.slice(0);
...
<polymer-element name="post-list" attributes="show" assetpath="polymer-tutorial-master/finished/">
  <template>
    <style>
    :host {
      display: block;
    ...
    <resume-data id="resume" resume="{{resume}}"></resume-data>
    

    <div layout="" vertical="" center="" hidden?="{{show != 'about'}}">
        <post-card>
          <div class="" layout="" horizontal="" center="">
                <img src="{{resume.basics.gravatar}}">
                <h2>{{resume.basics.name}}</h2>
          </div>
          <p>{{resume.basics.summary}}</p>
        </post-card>
    </div>
    <div layout="" vertical="" center="" hidden?="{{show != 'work'}}">
      <template repeat="{{work in resume.work}}">

        <post-card>
          <h2>{{work.company}}</h2>
          <h3>{{work.position}}</h3>
          <label>{{work.startDateYear}} - {{work.endDateYear}}</label>
          <p>{{work.summary}}</p>
          <ul>
        <template repeat="{{highlight in work.highlights}}">
        <li>{{highlight}}</li>
        </template>
        </ul>
        </post-card>
    ...
    <div layout="" vertical="" center="" hidden?="{{show != 'education'}}">
      <template repeat="{{education in resume.education}}">

        <post-card>
          <h2>{{education.institution}}</h2>
          <label>{{education.startDateYear}} - {{education.endDateYear}}</label>
    ...
    <div layout="" vertical="" center="" hidden?="{{show != 'references'}}">
      <template repeat="{{reference in resume.references}}">
  ...
  <core-header-panel>
    <core-toolbar>
      <paper-tabs id="tabs" selected="about" self-end="">
        ...
        <paper-tab name="work">Work</paper-tab>
        <paper-tab name="education">Education</paper-tab>
        <paper-tab name="references">References</paper-tab>
      </paper-tabs>
    </core-toolbar>
